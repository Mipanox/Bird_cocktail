...
# ----------- Parallel version ------------   #
#  parallelized in looping bird species       #
#  so MAX_SPEC* arguments no longer exist     #
#                                             #
...
if __name__ == "__main__":
    ...
    pool.map(runPreprocessing, birds) # for bird in birds: run f(bird)
